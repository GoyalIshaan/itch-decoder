...
inline void handleMWCBDeclineLevel(const char* buffer, size_t length, int log_fd) {
    ...
    msg.level_1_price = fast_ntohll(msg.level_1_price);
    msg.level_2_price = fast_ntohll(msg.level_2_price);
    msg.level_3_price = fast_ntohll(msg.level_3_price);
    ...
    // Write price levels
    offset += snprintf(csv_row + offset, sizeof(csv_row) - offset, "%llu,", msg.level_1_price);
    offset += snprintf(csv_row + offset, sizeof(csv_row) - offset, "%llu,", msg.level_2_price);
