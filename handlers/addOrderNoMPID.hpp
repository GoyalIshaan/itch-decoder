...
inline void handleAddOrderNoMPID(const char* buffer, size_t length, int log_fd) {
    ...
    AddOrderNoMPIDMessage msg = itch::PackedParser<AddOrderNoMPIDMessage>::parse(buffer, length);
